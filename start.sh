...
azure network nic create --resource-group HelloWorld --name eve-nic --location eastus --subnet-name HelloWorld-subnet --subnet-vnet-name 'HelloWorld-vnet' --public-ip-name evepublic
